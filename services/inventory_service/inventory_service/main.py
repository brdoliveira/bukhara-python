"""Pontos de saúde e prontidão do serviço de estoque."""
...
def create_app(kafka: DependencyProbe | None = None, postgres: DependencyProbe | None = None) -> InventoryApplication:
    return InventoryApplication(kafka or DependencyProbe(), postgres or DependencyProbe())
