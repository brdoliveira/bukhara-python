...
## T-001 — Fundação, contratos e resiliência compartilhada [concluida]
...
## T-002 — API e produtor do serviço de pedidos [concluida]
...
## T-003 — Consumidor do serviço de estoque [concluida]
...
## T-004 — Consumidor do serviço de pagamento [concluida]
...
## T-005 — Consumidor do serviço de notificação [concluida]
...
## T-006 — Infraestrutura local e teste da saga [concluida]
...
## T-007 — Documentação operacional [concluida]
