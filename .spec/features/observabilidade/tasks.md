...
## T-008 — Biblioteca compartilhada e contratos de telemetria [pendente]
...
## T-009 — Instrumentação dos quatro microsserviços [pendente]
...
## T-010 — Stack LGTM e dashboard provisionado [pendente]
...
## T-011 — Runbook de investigação [pendente]
